...
export const vocabulary: VocabularyItem[] = [
  ...
  { id: 'kirin',   themeId: 'doubutsu', word: 'きりん',   reading: 'きりん',   emoji: '🦒', hint: 'くびが ながい',           sortOrder: 4 },
  ...
  { id: 'penguin', themeId: 'doubutsu', word: 'ぺんぎん', reading: 'ぺんぎん', emoji: '🐧', hint: 'こおりの うえを あるく',   sortOrder: 8 },
  { id: 'raion',   themeId: 'doubutsu', word: 'らいおん', reading: 'らいおん', emoji: '🦁', hint: 'たてがみが りっぱ',       sortOrder: 9 },
  { id: 'panda',   themeId: 'doubutsu', word: 'ぱんだ',   reading: 'ぱんだ',   emoji: '🐼', hint: 'しろくろ もよう',         sortOrder: 10 },

  // === たべもの (10語) ===
  { id: 'ringo',    themeId: 'tabemono', word: 'りんご',       reading: 'りんご',       emoji: '🍎', hint: 'あかい くだもの',         sortOrder: 1 },
  { id: 'banana',   themeId: 'tabemono', word: 'ばなな',       reading: 'ばなな',       emoji: '🍌', hint: 'きいろくて ながい',       sortOrder: 2 },
  { id: 'onigiri',  themeId: 'tabemono', word: 'おにぎり',     reading: 'おにぎり',     emoji: '🍙', hint: 'ごはんを にぎったよ',     sortOrder: 3 },
  { id: 'pan',      themeId: 'tabemono', word: 'ぱん',         reading: 'ぱん',         emoji: '🍞', hint: 'あさごはんに たべる',      sortOrder: 4 },
  ...
  { id: 'cake',     themeId: 'tabemono', word: 'けーき',       reading: 'けーき',       emoji: '🎂', hint: 'おたんじょうびに たべる',  sortOrder: 10 },
  ...
  { id: 'orenji',   themeId: 'iro', word: 'おれんじ', reading: 'おれんじ', emoji: '🟠', hint: 'みかんの いろ',           sortOrder: 7 },
  { id: 'pink',     themeId: 'iro', word: 'ぴんく',   reading: 'ぴんく',   emoji: '🩷', hint: 'さくらの いろ',           sortOrder: 8 },
  ...
  { id: 'bus',        themeId: 'norimono', word: 'ばす',           reading: 'ばす',           emoji: '🚌', hint: 'たくさん のれる',              sortOrder: 5 },
  ...
  { id: 'rocket',     themeId: 'norimono', word: 'ろけっと',       reading: 'ろけっと',       emoji: '🚀', hint: 'うちゅうに いく',              sortOrder: 10 },
];
